...
Ext.define("Ext.locale.ru.form.field.Date", {
    ...
    invalidText: "Неверный формат даты, дата должна быть указана в формате: дд.мм.гггг",
    formatText: "Ожидаемый формат даты дд.мм.гггг.",
    format: "d.m.y",
...
Ext.define("Ext.locale.ru.form.Panel", {
...
Ext.define("Ext.locale.ru.form.RadioGroup", {
    ...
    blankText: "Вы должны выбрать один из элементов данной группы"
});